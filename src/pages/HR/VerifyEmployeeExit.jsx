...
const VerifyEmployeeExit = ({ notificationData, onNavigate }) => {
    ...
    useEffect(() => {
        if (roleId) {
            console.log('🎯 Initializing Employee Exit Verification — RoleID:', roleId);
            dispatch(fetchVerifyEmpExit(roleId));
        }
    }, [roleId, dispatch]);
    ...
    useEffect(() => {
        if (selectedItem?.Id) {
            console.log('🔍 Fetching Exit View — Id:', selectedItem.Id);
            dispatch(setSelectedId(selectedItem.Id));
            dispatch(fetchEmpExitById({
    ...
    const handleItemSelect = (item) => {
        console.log('✅ Selected Exit Item:', item);
    ...
    const buildApprovalPayload = (actionValue) => {
        ...
        const payload = {
            ...
            empRefNo:        exitView?.EmpRefNo        || selectedItem?.EmpRefNo        || '',
        ...
        console.log('📤 Employee Exit Approval Payload:', payload);
        return payload;
    };
    ...
    const handleActionClick = async (action) => {
        ...
        try {
            ...
            const result  = await dispatch(approveEmpExit(payload)).unwrap();
    ...
    // ── Stats cards ────────────────────────────────────────────────────────────
    const statsCards = [
        { icon: LogOut,       value: exitGrid.length,                   label: 'Total Records',        color: 'blue'   },
        { icon: Clock,        value: summary.pending || exitGrid.length, label: 'Pending Verification', color: 'purple' },
        { icon: CalendarDays, value: d.ResignationDate || '-',           label: 'Resignation Date',     color: 'indigo' },
        { icon: CalendarDays, value: d.RelievingDate   || '-',           label: 'Relieving Date',       color: 'violet' },
    ];
    ...
    const renderExitInfo = () => (
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-700 to-purple-700 px-4 py-3">
            ...
            <div className="p-6 bg-white dark:bg-gray-800">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-700">
                        <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 mb-3 shadow">
                            <UserCheck className="w-5 h-5 text-white" />
                        </div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Employee</p>
                        <p className="font-bold text-blue-700 dark:text-blue-300 text-sm">
                            {d.EmployeeName || d.EmpName || 'N/A'}
                        </p>
                        <p className="text-xs text-indigo-500 dark:text-indigo-400 mt-0.5 font-medium">{d.EmpRefNo}</p>
                        {d.DesignationName && (
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{d.DesignationName}</p>
                        )}
                    </div>

                    <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4 border border-purple-200 dark:border-purple-700">
                        <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 mb-3 shadow">
    ...
    const renderTimeline = () => (
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="divide-y divide-gray-100 dark:divide-gray-700 bg-white dark:bg-gray-800">
                ...
                {(d.NoticePereiodDays !== undefined && d.NoticePereiodDays !== null) && (
                    <div className="flex items-center justify-between px-5 py-3">
                        <span className="flex items-center space-x-2 text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">
        ...
        return (
            <div className="space-y-6">
                ...
                {detailsLoading && (
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-700">
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="text-blue-700 dark:text-blue-400 text-sm">Loading exit details...</span>
                        </div>
                    </div>
                )}
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl p-6 border-2 border-blue-200 dark:border-blue-700">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-blue-200 dark:border-blue-700">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-3">
                            ...
                            <p className="text-sm font-bold text-indigo-700 dark:text-indigo-300">{d.ResignationDate || '-'}</p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-3">
                ...
                <VerificationInput
                    ...
                    config={{
                        checkboxLabel: '✓ I have verified the exit details, dates, and supporting documents',
                        checkboxDescription: 'Including resignation date, relieving date, and employee information',
                        commentLabel: 'Verification Comments',
                        commentPlaceholder: 'Please verify the exit dates, employee details, and any discrepancies...',
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-4 border-b border-gray-200 dark:border-gray-700 rounded-t-xl">
                                <h2 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center space-x-2">
                                    ...
                                    <span>{selectedItem ? 'Exit Verification' : 'Exit Details'}</span>
                                </h2>
                            </div>
                                ...
                                {selectedItem ? renderDetailContent() : (
                                    <div className="text-center py-12">
                                        <div className="w-24 h-24 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/20 dark:to-purple-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                            <LogOut className="w-12 h-12 text-blue-500 dark:text-blue-400" />
                                        </div>
                                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
                                            No Exit Record Selected
                                        </h3>
                                        <p className="text-gray-500 dark:text-gray-400">
                                            Select an exit record from the list to view details and verify the employee exit.
                                        </p>
                                    </div>
                                )}
                            </div>
...
export default VerifyEmployeeExit;
