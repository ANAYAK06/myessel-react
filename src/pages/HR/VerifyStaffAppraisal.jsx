        ...
        <div className="space-y-6">
            ...
            <InboxSplitLayout
                ...
                left={{
                    ...
                    popupConfig: {
                        title: 'Appraisal Objective Verification',
                        icon: Target,
                        headerGradient: 'from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20',
                        maxWidth: 'max-w-[80vw]',
                    },
                ...
                right={{
                    ...
                    config: {
                        ...
                        icon: Target,
                        selectedTitle: 'Appraisal Objective Verification',
                        emptyTitle: 'No Record Selected',
                        emptyMessage: 'Select an appraisal objective from the list to view the details and take action.',
                        headerGradient: 'from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20',
